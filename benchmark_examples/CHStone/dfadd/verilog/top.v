...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
		...
		tmp_2_reg_184 <= a_input_q0_temp111;
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_105_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
		...
		tmp_reg_159 <= tmp_fu_117_p1_temp111;
    end
end
...
assign a_input_q0_temp121 = a_input_q0 >> 6'd63;

assign tmp_fu_117_p1_temp111 = tmp_reg_159_temp1211 | tmp_fu_117_p1_temp1211;
assign tmp_reg_159_temp1211 = tmp_reg_159 & 64'd18446744073709551584;
assign tmp_fu_117_p1_temp1211 = tmp_fu_117_p1 & 5'd31;
