...
void top(unsigned long long int *ap_clk__1,unsigned long long int *ap_done__1,unsigned long long int *ap_idle__1,unsigned long long int *ap_ready__1,unsigned long long int *ap_return__1,unsigned long long int *ap_rst__1,unsigned long long int *ap_start__1,int dummy,unsigned long long int * a_input_rom[],unsigned long long int * b_input_rom[],unsigned long long int * z_output_rom[]){
...
unsigned long long int ap_start=*ap_start__1;
   ...
   if(((exitcond_fu_105_p2 == 1) && (1 == ap_CS_fsm_state2)) == 1){
       ...
       {
           tmp_reg_159 =   (  ( tmp_reg_159__temp  & 18446744073709550592 )  |  ( i_reg_73__temp & 1023 )  ) ;
       }
       if(1 == ap_CS_fsm_state2)
       {
           a_input_ce0 =  1;
