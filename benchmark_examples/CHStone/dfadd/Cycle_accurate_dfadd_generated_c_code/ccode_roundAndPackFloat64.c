...
unsigned long long int zSign=*zSign__1;
  /*printf("inside round and pack 64\n");
  printf("zExp %llu\n",zExp);
  printf("zSig %llu\n",zSig);
  printf("zSign %llu\n",zSign);*/
   ...
   roundBits_1_reg_115__temp = roundBits_1_reg_115 ;
	  ...
	  //printf("zSig_assign_2_reg_472 %llu\n",zSig_assign_2_reg_472);
       }
   ...
   roundBits_1_reg_115__temp = roundBits_1_reg_115 ;
	 ...
	 /*printf("zSig_assign_2_reg_472__temp %llu\n",zSig_assign_2_reg_472__temp);
         printf("zExp_assign_1_reg_101__temp %llu\n",zExp_assign_1_reg_101__temp);
	printf("zSign %llu\n",zSign);
	printf("ap_phi_mux_p_0_phi_fu_129_p4 first %llu\n",ap_phi_mux_p_0_phi_fu_129_p4);*/
       }
	if(((1 == ap_CS_fsm_state4) && ((tmp_s_reg_427 == 0) || (((tmp_2_reg_435 == 0) && (tmp_1_reg_431 == 0)) || ((tmp_7_reg_439 == 0) && (tmp_1_reg_431 == 0)))))==0)
	   ...
	   //printf("ap_phi_mux_p_0_phi_fu_129_p4 second %llu\n",ap_phi_mux_p_0_phi_fu_129_p4);
       }
       if(1 == ap_CS_fsm_state4)
       {
           ap_ready =  1;
