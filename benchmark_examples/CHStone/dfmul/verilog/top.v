...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_104_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_reg_150 <= tmp_fu_116_p1_temp11;
    end
end
...
assign tmp_fu_116_p1_temp11 = tmp_reg_150_temp111 | tmp_fu_116_p1_temp111;
assign tmp_reg_150_temp111 = tmp_reg_150 & 1'd18446744073709551584;
assign tmp_fu_116_p1_temp111 = tmp_fu_116_p1 & 1'd31;
