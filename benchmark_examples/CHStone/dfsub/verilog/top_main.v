...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
		...
		tmp_2_reg_215 <= a_input_q0_temp111;
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_122_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
		...
		tmp_reg_190 <= tmp_fu_134_p1_temp111;
    end
end
...
assign a_input_q0_temp111 = a_input_q0_temp121 & 1'd1;
assign a_input_q0_temp121 = a_input_q0 >> 1'd63;

assign tmp_fu_134_p1_temp111 = tmp_reg_190_temp1211 | tmp_fu_134_p1_temp1211;
assign tmp_reg_190_temp1211 = tmp_reg_190 & 1'd18446744073709551584;
assign tmp_fu_134_p1_temp1211 = tmp_fu_134_p1 & 1'd31;
...
assign tmp_2_fu_144_p3 = a_input_q0_temp131 & 1'd1;
assign a_input_q0_temp131 = a_input_q0 >> 1'd63;

//assign tmp_3_fu_152_p3 = b_input_q0[32'd63];
assign tmp_3_fu_152_p3 = b_input_q0_temp131 & 1'd1;
assign b_input_q0_temp131 = b_input_q0 >> 1'd63;
