...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if (((or_ln82_fu_216_p2 == 1'd1) & (icmp_ln81_fu_183_p2 == 1'd0))) begin
            ap_phi_mux_f1_1_phi_fu_154_p4 = f1_0_reg_93;
        end else if (((icmp_ln81_fu_183_p2 == 1'd1) | (or_ln82_fu_216_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if (((icmp_ln81_fu_183_p2 == 1'd1) | (or_ln82_fu_216_p2 == 1'd0))) begin
            input3_address0 = zext_ln83_fu_234_p1;
        end else if (((or_ln82_fu_216_p2 == 1'd1) & (icmp_ln81_fu_183_p2 == 1'd0))) begin
...
assign f1_5_fu_332_p3 = ((and_ln90_fu_258_p2[0:0] === 1'b1) ? f1_4_reg_117 : ap_phi_mux_f1_1_phi_fu_154_p4);

assign f1_fu_239_p2 = ($signed(f1_0_reg_93) + $signed(32'd1));

assign f2_5_fu_292_p3 = ((icmp_ln94_fu_286_p2[0:0] === 1'b1) ? i2_fu_264_p2 : 32'd16);

assign f2_6_fu_324_p3 = ((and_ln90_fu_258_p2[0:0] === 1'b1) ? f2_5_fu_292_p3 : ap_phi_mux_f2_1_phi_fu_144_p4);

assign f2_7_fu_340_p3 = ((and_ln90_fu_258_p2[0:0] === 1'b1) ? f2_5_fu_292_p3 : i2_1_reg_105);

assign f2_fu_227_p2 = ($signed(f2_0_reg_81) + $signed(32'd1));

assign i2_fu_264_p2 = (i2_1_reg_105 + 32'd8);

assign i3_3_fu_316_p3 = ((icmp_ln95_fu_310_p2[0:0] === 1'b1) ? i3_fu_270_p2 : 32'd16);

assign i3_4_fu_348_p3 = ((and_ln90_fu_258_p2[0:0] === 1'b1) ? i3_3_fu_316_p3 : f1_4_reg_117);
...
assign t2_fu_189_p3 = ((icmp_ln81_fu_183_p2[0:0] === 1'b1) ? 32'd0 : input2_q1);

assign tmp_2_fu_300_p4 = {{i3_fu_270_p2[31:4]}};
