...
(* CORE_GENERATION_INFO="histogram,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.575000,HLS_SYN_LAT=769,HLS_SYN_TPT=770,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=372,HLS_SYN_LUT=716,HLS_VERSION=2019_2}" *)
...
histogram_map6 histogram_map6_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
histogram_map histogram_map_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
histogram_reduce histogram_reduce_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
