...
unsigned long long int in_r_q0=*in_r_q0__1;
   ...
   static unsigned long long int i_2_fu_171_p2=0;
   static unsigned long long int i_2_fu_171_p2__temp=0;
   static unsigned long long int i_2_reg_230=0;
   static unsigned long long int i_2_reg_230__temp=0;
...
switch(ap_status){
   ...
   i_2_fu_171_p2__temp = i_2_fu_171_p2 ;
...
in_r_ce0 = 0 ; 
   ...
   if(((icmp_ln10_fu_165_p2 == 1) && (1 == ap_CS_fsm_state4)) == 1){
       ...
       if(1 == ap_CS_fsm_state4)
       {
           i_2_reg_230 =   ( ( i1_0_reg_126__temp  + 1 ) & 7 ) ;
       }
...
in_r_ce0 = 0 ; 
       ...
       if(1 == ap_CS_fsm_state6)
       {
           i1_0_reg_126 =  i_2_reg_230__temp ;
       }
       if(1 == ap_CS_fsm_state6)
       {
