...
assign temp_I_fu_254_p2 = ($signed(add_ln54_reg_321) * $signed({{1'b0}, {temp_I_fu_254_p1}}));

assign temp_R_fu_249_p1 = zext_ln45_1_fu_245_p1;

assign temp_R_fu_249_p2 = ($signed(sub_ln53_reg_316) * $signed({{1'b0}, {temp_R_fu_249_p1}}));

assign tmp_2_fu_193_p4 = {{i_0_reg_161[31:10]}};

assign zext_ln45_1_fu_245_p1 = c_reg_138;

assign zext_ln45_fu_171_p1 = i_reg_150;

endmodule //fft_stage7
