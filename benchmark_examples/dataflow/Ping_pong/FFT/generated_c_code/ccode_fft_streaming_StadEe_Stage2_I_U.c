...
void fft_streaming_StadEe_Stage2_I_U(long long int *ap_status__1,unsigned long long int *clk__1,unsigned long long int *i_address0__1,unsigned long long int *i_address1__1,unsigned long long int *i_ce__1,unsigned long long int *i_ce0__1,unsigned long long int *i_ce1__1,unsigned long long int *i_d0__1,unsigned long long int *i_d1__1,unsigned long long int *i_full_n__1,unsigned long long int *i_q0__1,unsigned long long int *i_we0__1,unsigned long long int *i_we1__1,unsigned long long int *i_write__1,unsigned long long int *reset__1,unsigned long long int *t_address0__1,unsigned long long int *t_address1__1,unsigned long long int *t_ce__1,unsigned long long int *t_ce0__1,unsigned long long int *t_ce1__1,unsigned long long int *t_d0__1,unsigned long long int *t_d1__1,unsigned long long int *t_empty_n__1,unsigned long long int *t_q0__1,unsigned long long int *t_read__1,unsigned long long int *t_we0__1,unsigned long long int *t_we1__1,int dummy){
...
unsigned long long int t_d1=*t_d1__1;
...
unsigned long long int t_we1=*t_we1__1;
   ...
   static unsigned long long int buf_d1[2];
   static unsigned long long int buf_q0[2];
   static unsigned long long int buf_we0[2];
   static unsigned long long int buf_we1[2];
   ...
   static unsigned long long int i_d1__temp=0;
   ...
   static unsigned long long int i_we1__temp=0;
   ...
   static unsigned long long int t_d1__temp=0;
   ...
   static unsigned long long int t_we1__temp=0;
   static unsigned long long int tptr=0;
   static unsigned long long int tptr__temp=0;
   
   unsigned long long int i=0;
    static unsigned long long int ram[BufferCount][1024]; 
...
empty_n = 0 ; 
	...
	push_buf = (i_ce && i_write) && full_n ;  
       ...
       buf_ce0[i] = ((iptr == i) ? i_ce0 : (((tptr == i) && empty_n) ? t_ce0 : 0)) ;
		...
		buf_we1[i] = ((iptr == i) ? i_we1 : (((tptr == i) && empty_n) ? t_we1 : 0)) ;
		buf_a1[i] = ((iptr == i) ? i_address1 : t_address1) ;
		buf_d1[i] = ((iptr == i) ? i_d1 : t_d1) ;
       if(buf_ce0[i]){
			if(buf_we0[i]){
