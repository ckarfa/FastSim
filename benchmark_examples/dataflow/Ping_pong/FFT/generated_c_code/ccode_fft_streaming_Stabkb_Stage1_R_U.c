#include<stdio.h>
#define fft_streaming_Stabkb_memcore_MEM_SIZE 2048
#define BufferCount 2
void fft_streaming_Stabkb_Stage1_R_U(long long int *ap_status__1,unsigned long long int *clk__1,unsigned long long int *i_address0__1,unsigned long long int *i_ce__1,unsigned long long int *i_ce0__1,unsigned long long int *i_d0__1,unsigned long long int *i_full_n__1,unsigned long long int *i_q0__1,unsigned long long int *i_we0__1,unsigned long long int *i_write__1,unsigned long long int *reset__1,unsigned long long int *t_address0__1,unsigned long long int *t_ce__1,unsigned long long int *t_ce0__1,unsigned long long int *t_d0__1,unsigned long long int *t_empty_n__1,unsigned long long int *t_q0__1,unsigned long long int *t_read__1,unsigned long long int *t_we0__1,int dummy){
...
unsigned long long int t_we0=*t_we0__1;
   ...
   static unsigned long long int fft_streaming_Stabkb_memcore_ram[fft_streaming_Stabkb_memcore_MEM_SIZE];
...
t_empty_n = empty_n ;  
	...
	if(i_ce0){
          i_q0=fft_streaming_Stabkb_memcore_ram[memcore_iaddr];
           if(i_we0){
              fft_streaming_Stabkb_memcore_ram[memcore_iaddr]=i_d0;
           }
       }
       if(t_ce0){
          t_q0=fft_streaming_Stabkb_memcore_ram[memcore_taddr];
           if(t_we0){
              fft_streaming_Stabkb_memcore_ram[memcore_taddr]=t_d0;
           }
       }
