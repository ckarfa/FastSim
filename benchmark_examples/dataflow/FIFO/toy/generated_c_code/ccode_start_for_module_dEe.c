...
unsigned long long int reset=*reset__1;
   ...
   static unsigned long long int shiftReg_q__temp=0;
       ...
       if_dout = shiftReg_q ;  
       shiftReg_addr = (((mOutPtr>>ADDR_WIDTH) & 1) == 0) ? ((mOutPtr>>(ADDR_WIDTH - 1)) & 1) : 0 ; 
