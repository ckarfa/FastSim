...
if(!(reset == 1)){
if((((if_read && if_read_ce__temp) == 1) && (internal_empty_n__temp == 1)) && (((if_write__temp && if_write_ce__temp) == 0) || (internal_full_n__temp == 0))){
