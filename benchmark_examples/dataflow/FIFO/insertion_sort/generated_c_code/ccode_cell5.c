#include<stdio.h>
void cell5(unsigned long long int *ap_clk__1,unsigned long long int *ap_continue__1,unsigned long long int *ap_done__1,unsigned long long int *ap_idle__1,unsigned long long int *ap_ready__1,unsigned long long int *ap_rst__1,unsigned long long int *ap_start__1,long long int *ap_status__1,unsigned long long int *in_V_dout__1,unsigned long long int *in_V_empty_n__1,unsigned long long int *in_V_read__1,unsigned long long int *out_V_din__1,unsigned long long int *out_V_full_n__1,unsigned long long int *out_V_write__1,unsigned long long int *start_full_n__1,unsigned long long int *start_out__1,unsigned long long int *start_write__1,int dummy){
...
unsigned long long int start_write=*start_write__1;
   ...
   static unsigned long long int icmp_ln77_fu_41_p2=0;
   static unsigned long long int icmp_ln77_fu_41_p2__temp=0;
   ...
   static unsigned long long int localCopy_4=0;
   static unsigned long long int localCopy_4__temp=0;
...
switch(ap_status){
   ...
   ap_rst__temp = ap_rst ;
   icmp_ln77_fu_41_p2__temp = icmp_ln77_fu_41_p2 ;
   ap_clk__temp = ap_clk ;
   ap_NS_fsm__temp = ap_NS_fsm ;
   start_once_reg__temp = start_once_reg ;
   localCopy_4__temp = localCopy_4 ;
...
start_once_reg = 0 ; 
       ...
       if(!((!(((((real_start == 0) || (in_V_empty_n == 0)) || (ap_done_reg == 1)) || ((icmp_ln77_fu_41_p2 == 0) && (out_V_full_n == 0))) || ((icmp_ln77_fu_41_p2 == 1) && (out_V_full_n == 0)))) && (1 == ap_CS_fsm_state1))){
ap_done = ap_done_reg ; 
}
...
in_V_read = 0 ; 
       ...
       if(!((((!((real_start == 0) || (ap_done_reg == 1))) && (icmp_ln77_fu_41_p2 == 0)) && (1 == ap_CS_fsm_state1)) || (((!((real_start == 0) || (ap_done_reg == 1))) && (icmp_ln77_fu_41_p2 == 1)) && (1 == ap_CS_fsm_state1)))){
out_V_blk_n = 1 ; 
}
       
       if(!((((!(((((real_start == 0) || (in_V_empty_n == 0)) || (ap_done_reg == 1)) || ((icmp_ln77_fu_41_p2 == 0) && (out_V_full_n == 0))) || ((icmp_ln77_fu_41_p2 == 1) && (out_V_full_n == 0)))) && (icmp_ln77_fu_41_p2 == 0)) && (1 == ap_CS_fsm_state1)) || (((!(((((real_start == 0) || (in_V_empty_n == 0)) || (ap_done_reg == 1)) || ((icmp_ln77_fu_41_p2 == 0) && (out_V_full_n == 0))) || ((icmp_ln77_fu_41_p2 == 1) && (out_V_full_n == 0)))) && (icmp_ln77_fu_41_p2 == 1)) && (1 == ap_CS_fsm_state1)))){
out_V_write = 0 ; 
}
...
start_write = 0 ; 
       ...
       ap_block_state1 =  ( (  ( (  ( (  ( (  ( ( real_start == 0 ) & 1 )  |  ( ( ( in_V_empty_n & 1 )  == 0 ) & 1 )  ) & 1 )  |  ( ( ap_done_reg == 1 ) & 1 )  ) & 1 )  |  ( (  ( (  ( do_twos_complement( ( in_V_dout & 4294967295 )  , 63 )  > do_twos_complement( localCopy_4 , 63 )  ? 1 : 0 )  == 0 ) & 1 )  &  ( ( ( out_V_full_n & 1 )  == 0 ) & 1 )  ) & 1 )  ) & 1 )  |  ( (  ( (  ( do_twos_complement( ( in_V_dout & 4294967295 )  , 63 )  > do_twos_complement( localCopy_4 , 63 )  ? 1 : 0 )  == 1 ) & 1 )  &  ( ( ( out_V_full_n & 1 )  == 0 ) & 1 )  ) & 1 )  ) & 1 )  ; 
       ap_condition_72 =  ( ( ( ( ! (  ( (  ( (  ( (  ( (  ( ( real_start == 0 ) & 1 )  |  ( ( ( in_V_empty_n & 1 )  == 0 ) & 1 )  ) & 1 )  |  ( ( ap_done_reg == 1 ) & 1 )  ) & 1 )  |  ( (  ( (  ( do_twos_complement( ( in_V_dout & 4294967295 )  , 63 )  > do_twos_complement( localCopy_4 , 63 )  ? 1 : 0 )  == 0 ) & 1 )  &  ( ( ( out_V_full_n & 1 )  == 0 ) & 1 )  ) & 1 )  ) & 1 )  |  ( (  ( (  ( do_twos_complement( ( in_V_dout & 4294967295 )  , 63 )  > do_twos_complement( localCopy_4 , 63 )  ? 1 : 0 )  == 1 ) & 1 )  &  ( ( ( out_V_full_n & 1 )  == 0 ) & 1 )  ) & 1 )  ) & 1 )  ) ) & 1 )  &  ( ( 1 == ap_CS_fsm_state1 ) & 1 )  ) & 1 )  ; 
               
               in_V_empty_n =  ( in_V_empty_n & 1 ) ;
               out_V_full_n =  ( out_V_full_n & 1 ) ;
               icmp_ln77_fu_41_p2 =   ( do_twos_complement( ( in_V_dout & 4294967295 )  , 63 )  > do_twos_complement( localCopy_4__temp  , 63 )  ? 1 : 0 ) ;
       if((!(((((real_start == 0) || (in_V_empty_n == 0)) || (ap_done_reg == 1)) || ((icmp_ln77_fu_41_p2 == 0) && (out_V_full_n == 0))) || ((icmp_ln77_fu_41_p2 == 1) && (out_V_full_n == 0)))) && (1 == ap_CS_fsm_state1))
       {
           ap_done =  1;
            if(ap_done==1){
...
internal_ap_ready = 0 ; 
       ...
       if((icmp_ln77_fu_41_p2 == 1) && (1 == ap_condition_72)){
out_V_din = localCopy_4 ; 
}
if(!((icmp_ln77_fu_41_p2 == 1) && (1 == ap_condition_72))){
if((icmp_ln77_fu_41_p2 == 0) && (1 == ap_condition_72)){
...
out_V_din = 0 ; 
       ...
       if(((!(((((real_start == 0) || (in_V_empty_n == 0)) || (ap_done_reg == 1)) || ((icmp_ln77_fu_41_p2 == 0) && (out_V_full_n == 0))) || ((icmp_ln77_fu_41_p2 == 1) && (out_V_full_n == 0)))) && (icmp_ln77_fu_41_p2 == 1)) && (1 == ap_CS_fsm_state1))
       {
           localCopy_4 =  ( in_V_dout & 4294967295 ) ;
       }
       if(!(ap_continue == 1)){
       if((!(((((real_start == 0) || (in_V_empty_n == 0)) || (ap_done_reg == 1)) || ((icmp_ln77_fu_41_p2 == 0) && (out_V_full_n == 0))) || ((icmp_ln77_fu_41_p2 == 1) && (out_V_full_n == 0)))) && (1 == ap_CS_fsm_state1))
       {
