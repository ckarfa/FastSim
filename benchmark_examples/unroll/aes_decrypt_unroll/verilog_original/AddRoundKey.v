...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        or_ln566_1_reg_846[5 : 2] <= or_ln566_1_fu_517_p2[5 : 2];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        or_ln566_2_reg_871[5 : 2] <= or_ln566_2_fu_591_p2[5 : 2];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        or_ln566_reg_821[5 : 2] <= or_ln566_fu_443_p2[5 : 2];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        shl_ln_reg_773[5 : 2] <= shl_ln_fu_378_p3[5 : 2];
...
assign shl_ln_fu_378_p3 = {{trunc_ln566_fu_374_p1}, {2'd0}};
...
assign trunc_ln566_fu_374_p1 = n[3:0];
...
always @ (posedge ap_clk) begin
    shl_ln_reg_773[1:0] <= 2'b00;
    or_ln566_reg_821[1:0] <= 2'b01;
    or_ln566_1_reg_846[1:0] <= 2'b10;
    or_ln566_2_reg_871[1:0] <= 2'b11;
end
