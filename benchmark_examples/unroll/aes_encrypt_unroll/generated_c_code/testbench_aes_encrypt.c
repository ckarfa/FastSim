...
int main(){
		...
		{			
			...
			{				
				...
				unsigned long long int round_val1=0;
				...
				unsigned long long int *round_val__1=&round_val1;
				int clock=0;
				int *dummy=&clock;

				aes_func_call(ap_clk1,ap_done1,ap_idle1,ap_ready1,ap_rst1,ap_start1,round_val__1,statemt1_address0__1,statemt1_ce0__1,statemt1_d0__1,statemt1_q0__1,statemt1_we0__1,input,dummy);
				//aes_main(input);
