...
MixColumn_AddRoundKe grp_MixColumn_AddRoundKe_fu_110(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
ByteSub_ShiftRow grp_ByteSub_ShiftRow_fu_119(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        i_2_cast1_reg_218[5 : 0] <= i_2_cast1_fu_175_p1[5 : 0];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        i_cast2_reg_192[5 : 0] <= i_cast2_fu_136_p1[5 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    i_cast2_reg_192[31:6] <= 26'b00000000000000000000000000;
    i_2_cast1_reg_218[31:6] <= 26'b00000000000000000000000000;
end

endmodule //aes_func_call
