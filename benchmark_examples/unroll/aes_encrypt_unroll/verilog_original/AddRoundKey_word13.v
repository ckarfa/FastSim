...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module AddRoundKey_word13_rom (
...
initial begin
    $readmemh("./AddRoundKey_word13_rom.dat", ram0);
    $readmemh("./AddRoundKey_word13_rom.dat", ram1);
end
...
AddRoundKey_word13_rom AddRoundKey_word13_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
