...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln250_fu_395_p2 == 1'd0))) begin
        ...
        sext_ln253_reg_793[31 : 1] <= sext_ln253_fu_439_p1[31 : 1];
        sub_ln253_1_reg_798[6 : 1] <= sub_ln253_1_fu_458_p2[6 : 1];
    end
end
...
assign f_function_res_fu_659_p3 = {{trunc_ln269_1_reg_833}, {trunc_ln269_fu_655_p1}};
...
assign inv_init_perm_res_fu_705_p3 = {{trunc_ln308_1_reg_866}, {trunc_ln308_fu_701_p1}};
...
assign s_input_fu_360_p3 = {{trunc_ln235_1_reg_765}, {trunc_ln235_fu_356_p1}};

assign s_output_fu_600_p3 = {{trunc_ln259_1_fu_596_p1}, {S_q0}};
...
assign shl_ln_fu_411_p3 = {{trunc_ln253_fu_407_p1}, {3'd0}};
...
assign tmp_3_fu_542_p4 = {{{tmp_s_fu_503_p4}, {or_ln254_fu_497_p2}}, {4'd0}};

assign tmp_4_fu_574_p3 = {{j_1_reg_231}, {6'd0}};

assign tmp_fu_490_p3 = lshr_ln253_1_reg_803[32'd4];

assign tmp_s_fu_503_p4 = {{lshr_ln253_1_reg_803[7:5]}};

assign trunc_ln235_1_fu_337_p1 = s_input_0_reg_219[62:0];

assign trunc_ln235_fu_356_p1 = lshr_ln235_fu_350_p2[0:0];

assign trunc_ln241_1_fu_371_p1 = sub_key_q0[47:0];

assign trunc_ln241_2_fu_375_p1 = s_input_0_reg_219[46:0];

assign trunc_ln241_3_fu_379_p1 = sub_key_q0[46:0];

assign trunc_ln241_fu_367_p1 = s_input_0_reg_219[47:0];

assign trunc_ln253_1_fu_487_p1 = lshr_ln253_1_reg_803[0:0];

assign trunc_ln253_fu_407_p1 = j_1_reg_231[2:0];

assign trunc_ln259_1_fu_596_p1 = s_output_1_fu_94[27:0];

assign trunc_ln259_fu_556_p1 = lshr_ln256_1_fu_536_p2[7:0];

assign trunc_ln269_1_fu_630_p1 = f_function_res_0_reg_254[30:0];

assign trunc_ln269_fu_655_p1 = lshr_ln269_fu_649_p2[0:0];

assign trunc_ln308_1_fu_683_p1 = inv_init_perm_res_0_s_reg_276[62:0];

assign trunc_ln308_fu_701_p1 = lshr_ln308_fu_696_p2[0:0];
...
always @ (posedge ap_clk) begin
    sext_ln253_reg_793[0] <= 1'b0;
    sub_ln253_1_reg_798[0] <= 1'b0;
end
