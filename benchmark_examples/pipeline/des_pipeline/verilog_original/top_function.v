...
(* CORE_GENERATION_INFO="top_function,hls_ip_2019_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.317333,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=1582,HLS_SYN_LUT=2731,HLS_VERSION=2019_2}" *)
...
shiftingcidi grp_shiftingcidi_fu_187(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        C_assign_reg_427 <= {{permuted_choice_1_0_s_reg_175[55:28]}};
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        L1_reg_393 <= {{init_perm_res_0_i_reg_152[63:32]}};
...
assign R1_fu_283_p1 = init_perm_res_0_i_reg_152[31:0];
...
assign init_perm_res_fu_265_p3 = {{trunc_ln39_1_fu_261_p1}, {trunc_ln39_fu_257_p1}};
...
assign permuted_choice_1_fu_331_p3 = {{trunc_ln70_1_fu_327_p1}, {trunc_ln70_fu_323_p1}};
...
assign trunc_ln39_1_fu_261_p1 = init_perm_res_0_i_reg_152[62:0];

assign trunc_ln39_fu_257_p1 = lshr_ln39_fu_251_p2[0:0];

assign trunc_ln70_1_fu_327_p1 = permuted_choice_1_0_s_reg_175[62:0];

assign trunc_ln70_fu_323_p1 = lshr_ln70_fu_317_p2[0:0];

assign trunc_ln74_fu_350_p1 = permuted_choice_1_0_s_reg_175[27:0];
