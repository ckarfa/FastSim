...
always @ (posedge ap_clk) begin
    if (((icmp_ln563_fu_175_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        shl_ln_reg_313[3 : 2] <= shl_ln_fu_216_p3[3 : 2];
        statemt_addr_26_reg_324[3 : 2] <= zext_ln567_fu_235_p1[3 : 2];
        statemt_addr_reg_319[3 : 2] <= zext_ln566_fu_224_p1[3 : 2];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        shl_ln566_1_reg_285[5 : 2] <= shl_ln566_1_fu_163_p3[5 : 2];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        statemt_addr_27_reg_339[3 : 2] <= zext_ln568_fu_270_p1[3 : 2];
        statemt_addr_28_reg_344[3 : 2] <= zext_ln569_fu_280_p1[3 : 2];
    end
end
...
assign shl_ln566_1_fu_163_p3 = {{trunc_ln566_fu_159_p1}, {2'd0}};

assign shl_ln_fu_216_p3 = {{trunc_ln566_1_fu_212_p1}, {2'd0}};

assign statemt_d0 = reg_149;

assign statemt_d1 = reg_154;

assign trunc_ln566_1_fu_212_p1 = j_0_reg_126[1:0];

assign trunc_ln566_fu_159_p1 = n[3:0];
...
always @ (posedge ap_clk) begin
    shl_ln566_1_reg_285[1:0] <= 2'b00;
    shl_ln_reg_313[1:0] <= 2'b00;
    statemt_addr_reg_319[1:0] <= 2'b00;
    statemt_addr_reg_319[4] <= 1'b0;
    statemt_addr_26_reg_324[1:0] <= 2'b01;
    statemt_addr_26_reg_324[4] <= 1'b0;
    statemt_addr_27_reg_339[1:0] <= 2'b10;
    statemt_addr_27_reg_339[4] <= 1'b0;
    statemt_addr_28_reg_344[1:0] <= 2'b11;
    statemt_addr_28_reg_344[4] <= 1'b0;
end
