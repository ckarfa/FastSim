...
int main(){
		...
		fscanf(fp,"%s",&line);
			...
			{				
				...
				aes_func_call(input, ap_clk1, ap_done1, ap_idle1, ap_ready1, ap_rst1, ap_start1, statemt1_address0__1, statemt1_ce0__1, statemt1_d0__1, statemt1_q0__1, statemt1_we0__1, dummy1);
				//aes_main(input);
