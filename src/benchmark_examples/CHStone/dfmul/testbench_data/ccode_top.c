...
void top(int *ap_clk__1,int *ap_done__1,int *ap_idle__1,int *ap_ready__1,int *ap_return__1,int *ap_rst__1,int *ap_start__1,int dummy,unsigned long long a_input_rom[],unsigned long long b_input_rom[],unsigned long long z_output_rom[]){
...
float64_mul(&x1_reg_165,&ap_clk,&grp_float64_mul_fu_94_ap_done,&grp_float64_mul_fu_94_ap_idle,&grp_float64_mul_fu_94_ap_ready,&grp_float64_mul_fu_94_ap_return,&ap_rst,&grp_float64_mul_fu_94_ap_start,&x2_reg_170,dummy);
grp_float64_mul_fu_94_ap_done=1;
   ...
   if(((grp_float64_mul_fu_94_ap_done == 1) && (1 == ap_CS_fsm_state5)) == 1){
       ...
       if((grp_float64_mul_fu_94_ap_done == 1) && (1 == ap_CS_fsm_state5))
       {
           ...
           printf("%d Main result:%d\n",i_reg_71,main_result_reg_82);
       }
          a_input_address0 =  i_reg_71__temp ;
          b_input_address0 =  i_reg_71__temp ;
          z_output_address0 =  tmp_reg_150__temp ;
