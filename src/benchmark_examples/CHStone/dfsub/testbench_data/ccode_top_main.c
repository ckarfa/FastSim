...
grp_subFloat64Sigs_fu_111_ap_done=1;
   ...
   grp_subFloat64Sigs_fu_111_ap_return__temp = grp_subFloat64Sigs_fu_111_ap_return ;
       ...
       if(1 == ap_CS_fsm_state6)
       {
		   ...
		   printf("main_result:%d - %d/30000\n",main_result_reg_88,i_reg_77);
       }
