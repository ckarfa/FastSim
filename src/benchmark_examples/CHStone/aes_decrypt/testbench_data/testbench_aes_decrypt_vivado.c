...
void
InversShiftRow_ByteSub1 (int statemt[32], int nb)
{
  int temp;
  int invSbox1[16][16] = {
  ...
  switch (nb)
    {
    case 4:
      temp = invSbox1[statemt[13] >> 4][statemt[13] & 0xf];
      statemt[13] = invSbox1[statemt[9] >> 4][statemt[9] & 0xf];
      statemt[9] = invSbox1[statemt[5] >> 4][statemt[5] & 0xf];
      statemt[5] = invSbox1[statemt[1] >> 4][statemt[1] & 0xf];
      statemt[1] = temp;

      temp = invSbox1[statemt[14] >> 4][statemt[14] & 0xf];
      statemt[14] = invSbox1[statemt[6] >> 4][statemt[6] & 0xf];
      statemt[6] = temp;
      temp = invSbox1[statemt[2] >> 4][statemt[2] & 0xf];
      statemt[2] = invSbox1[statemt[10] >> 4][statemt[10] & 0xf];
      statemt[10] = temp;

      temp = invSbox1[statemt[15] >> 4][statemt[15] & 0xf];
      statemt[15] = invSbox1[statemt[3] >> 4][statemt[3] & 0xf];
      statemt[3] = invSbox1[statemt[7] >> 4][statemt[7] & 0xf];
      statemt[7] = invSbox1[statemt[11] >> 4][statemt[11] & 0xf];
      statemt[11] = temp;

      statemt[0] = invSbox1[statemt[0] >> 4][statemt[0] & 0xf];
      statemt[4] = invSbox1[statemt[4] >> 4][statemt[4] & 0xf];
      statemt[8] = invSbox1[statemt[8] >> 4][statemt[8] & 0xf];
      statemt[12] = invSbox1[statemt[12] >> 4][statemt[12] & 0xf];
      break;
    case 6:
      temp = invSbox1[statemt[21] >> 4][statemt[21] & 0xf];
      statemt[21] = invSbox1[statemt[17] >> 4][statemt[17] & 0xf];
      statemt[17] = invSbox1[statemt[13] >> 4][statemt[13] & 0xf];
      statemt[13] = invSbox1[statemt[9] >> 4][statemt[9] & 0xf];
      statemt[9] = invSbox1[statemt[5] >> 4][statemt[5] & 0xf];
      statemt[5] = invSbox1[statemt[1] >> 4][statemt[1] & 0xf];
      statemt[1] = temp;

      temp = invSbox1[statemt[22] >> 4][statemt[22] & 0xf];
      statemt[22] = invSbox1[statemt[14] >> 4][statemt[14] & 0xf];
      statemt[14] = invSbox1[statemt[6] >> 4][statemt[6] & 0xf];
      statemt[6] = temp;
      temp = invSbox1[statemt[18] >> 4][statemt[18] & 0xf];
      statemt[18] = invSbox1[statemt[10] >> 4][statemt[10] & 0xf];
      statemt[10] = invSbox1[statemt[2] >> 4][statemt[2] & 0xf];
      statemt[2] = temp;

      temp = invSbox1[statemt[15] >> 4][statemt[15] & 0xf];
      statemt[15] = invSbox1[statemt[3] >> 4][statemt[3] & 0xf];
      statemt[3] = temp;
      temp = invSbox1[statemt[19] >> 4][statemt[19] & 0xf];
      statemt[19] = invSbox1[statemt[7] >> 4][statemt[7] & 0xf];
      statemt[7] = temp;
      temp = invSbox1[statemt[23] >> 4][statemt[23] & 0xf];
      statemt[23] = invSbox1[statemt[11] >> 4][statemt[11] & 0xf];
      statemt[11] = temp;
      ...
      statemt[8] = invSbox1[statemt[8] >> 4][statemt[8] & 0xf];
      statemt[12] = invSbox1[statemt[12] >> 4][statemt[12] & 0xf];
      statemt[16] = invSbox1[statemt[16] >> 4][statemt[16] & 0xf];
      statemt[20] = invSbox1[statemt[20] >> 4][statemt[20] & 0xf];
      break;
    case 8:
      temp = invSbox1[statemt[29] >> 4][statemt[29] & 0xf];
      statemt[29] = invSbox1[statemt[25] >> 4][statemt[25] & 0xf];
      statemt[25] = invSbox1[statemt[21] >> 4][statemt[21] & 0xf];
      statemt[21] = invSbox1[statemt[17] >> 4][statemt[17] & 0xf];
      statemt[17] = invSbox1[statemt[13] >> 4][statemt[13] & 0xf];
      statemt[13] = invSbox1[statemt[9] >> 4][statemt[9] & 0xf];
      statemt[9] = invSbox1[statemt[5] >> 4][statemt[5] & 0xf];
      ...
      temp = invSbox1[statemt[30] >> 4][statemt[30] & 0xf];
      statemt[30] = invSbox1[statemt[18] >> 4][statemt[18] & 0xf];
      statemt[18] = invSbox1[statemt[6] >> 4][statemt[6] & 0xf];
      statemt[6] = invSbox1[statemt[26] >> 4][statemt[26] & 0xf];
      statemt[26] = invSbox1[statemt[14] >> 4][statemt[14] & 0xf];
      statemt[14] = invSbox1[statemt[2] >> 4][statemt[2] & 0xf];
      statemt[2] = invSbox1[statemt[22] >> 4][statemt[22] & 0xf];
      statemt[22] = invSbox1[statemt[10] >> 4][statemt[10] & 0xf];
      statemt[10] = temp;

      temp = invSbox1[statemt[31] >> 4][statemt[31] & 0xf];
      statemt[31] = invSbox1[statemt[15] >> 4][statemt[15] & 0xf];
      statemt[15] = temp;
      temp = invSbox1[statemt[27] >> 4][statemt[27] & 0xf];
      statemt[27] = invSbox1[statemt[11] >> 4][statemt[11] & 0xf];
      statemt[11] = temp;
      temp = invSbox1[statemt[23] >> 4][statemt[23] & 0xf];
      statemt[23] = invSbox1[statemt[7] >> 4][statemt[7] & 0xf];
      statemt[7] = temp;
      temp = invSbox1[statemt[19] >> 4][statemt[19] & 0xf];
      statemt[19] = invSbox1[statemt[3] >> 4][statemt[3] & 0xf];
      statemt[3] = temp;
      ...
      statemt[16] = invSbox1[statemt[16] >> 4][statemt[16] & 0xf];
      statemt[20] = invSbox1[statemt[20] >> 4][statemt[20] & 0xf];
      statemt[24] = invSbox1[statemt[24] >> 4][statemt[24] & 0xf];
      statemt[28] = invSbox1[statemt[28] >> 4][statemt[28] & 0xf];
      break;
    }
...
int part_one1(int statemt[32],int x,int i,int j, int ret[32]){
	x = (statemt[i + j * 4] << 1);
		if ((x >> 8) == 1)
		  x ^= 283;
		x ^= statemt[i + j * 4];
...
int part_three1(int statemt[32],int x,int i,int j, int ret[32]){
...
/* ******** InversMixColumn ********** */
int
AddRoundKey_InversMixColumn1 (int statemt[32], int nb, int n,int word[4][120])
{
  int ret[8 * 4], i, j;
  register int x;
    ...
    for (i = 0; i < 4; ++i)
      {
    	...
    	x=part_one1(statemt,x,i,j,ret);
    	ret[i + j * 4] ^= x;

		x=part_three1(statemt,x,i,j,ret);
		ret[i + j * 4] ^= x;
      }
	  ...
	  for (j = nk; j < nb * (round_val + 1); ++j)
		{
		  ...
		  if ((j % nk) == 0)
		{
		  temp[0] = SubByte1 (word[1][j - 1]) ^ Rcon01[(j / nk) - 1];
		  temp[1] = SubByte1 (word[2][j - 1]);
		  temp[2] = SubByte1 (word[3][j - 1]);
		  temp[3] = SubByte1 (word[0][j - 1]);
		}
		  if ((j % nk) != 0)
		{
		  temp[0] = word[0][j - 1];
...
void aes_decrypt_call1(int statemt1[32]){
	int i;
	int type=128128;
	int nb=4;
	int round_val=10;
	...
	AddRoundKey1 (statemt, type, round_val, word);
	InversShiftRow_ByteSub1 (statemt, nb);
	for (i = round_val - 1; i >= 1; --i)
		{
		  AddRoundKey_InversMixColumn1 (statemt, nb, i,word);
		  InversShiftRow_ByteSub1 (statemt, nb);
		}
	AddRoundKey1 (statemt, type, 0, word);
	for(i=0;i<32;i++)
		statemt1[i]=statemt[i];
}

int
decrypt1 (int statemt[32], int key[32], int type)
{
  int i;
/*
+--------------------------------------------------------------------------+
...
*/
  ...
  switch (type)
	...
	for(j=0;j<1000;j++){
		for(i=0;i<32;i++)
			statemt1[i]=statemt[i];
		aes_decrypt_call1(statemt);
		//printf("Generated C Simulation : %d / 1000 \n",j+1);
	}
  int main_result=0;
  for (i = 0; i < 16; i++)
...
void aes_func_call1(int statemt1[32]){
  ...
  ByteSub_ShiftRow1 (statemt, nb);
  AddRoundKey1 (statemt, type, i,word);
  for(i=0;i<32;i++)
	statemt1[i]=statemt[i];
}
...
int main(){
		...
		{			
			...
			{				
				...
				//aes_decrypt_call(input,ap_clk1,ap_done1,ap_idle1,ap_ready1,ap_rst1,ap_start1,statement_address0__1,statement_address1__1,statement_ce0__1,statement_ce1__1,statement_d0__1,statement_d1__1,statement_q0__1,statement_q1__1,statement_we0__1,statement_we1__1,dummy);
				aes_main(input);
				aes_main1(input);
